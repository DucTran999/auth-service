...
// RefreshToken provides a mock function for the type AuthUseCase
func (_mock *AuthUseCase) RefreshToken(ctx context.Context, refreshToken string) (*dto.TokenPairs, error) {
...
func (_c *AuthUseCase_RefreshToken_Call) Return(tokenPairs *dto.TokenPairs, err error) *AuthUseCase_RefreshToken_Call {
	_c.Call.Return(tokenPairs, err)
	return _c
}

func (_c *AuthUseCase_RefreshToken_Call) RunAndReturn(run func(ctx context.Context, refreshToken string) (*dto.TokenPairs, error)) *AuthUseCase_RefreshToken_Call {
	_c.Call.Return(run)
	return _c
}
